...
import org.eclipse.jakarta.hello.infraestructure.persistence.bd.ingrediet.IngredientImpl;
import org.eclipse.jakarta.hello.infraestructure.persistence.bd.ingrediet.IngredientJpaRepositoryImpl;
...
public class IngredientIRESTserviceImpl {
    ...
    @POST
    @Path("create")
    public Response create(IngredientImpl entity) {
        return Response
                .status(200)
    ...
    @PUT
    @Path("update")
    public Response update(IngredientImpl entity) {
